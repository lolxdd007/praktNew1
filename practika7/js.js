...
function zagadka1() {
  let otvet1 = prompt("Загадка 1: Какое животное гавкает?"); 
  let otvet = prompt("Ваш ответ:");
  if (otvet.toLowerCase() === "Собака" || otvet.toLowerCase() === "псина") { 
    otgadki++;
    zagadka2();
  } else {
    alert("Неверно");
...
function zagadka2() {
  let otvet1 = prompt("Загадка 2:  Сколько букв в слове 'Папа'?");
  let otvet = prompt("Ваш ответ:");
  if (otvet === "4") {
    otgadki++;
  } else {
