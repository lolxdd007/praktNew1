const postersData = [
    { id: 1, title: "Гамлет", image: "Hamlet.jpg", available: 10, cost: 500 },
    { id: 2, title: "Ромео и Джульетта", image: "RomeoJuliet.jpg", available: 5, cost: 600 },
    { id: 3, title: "Король Лир", image: "KingLear.jpg", available: 0, cost: 700 },
    { id: 4, title: "Вишневый сад", image: "CherryOrchard.jpg", available: 3, cost: 400 },
    { id: 5, title: "Мастер и Маргарита", image: "MasterMargarita.jpg", available: 3, cost: 400 },
    { id: 6, title: "Евгений Онегин", image: "EugeneOnegin.jpg", available: 3, cost: 400 },
    { id: 7, title: "Ревизор", image: "Inspector.jpg", available: 3, cost: 400 },
    { id: 8, title: "Три сестры", image: "ThreeSisters.jpg", available: 3, cost: 400 },
];
...
function handleBuyTicket(posterId) {
    ...
    if (poster.available > 0) {
        ...
        alert("Билеты на этот спектакль закончились!");
    }
}
